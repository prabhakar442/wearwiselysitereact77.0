...
const ShoePage = () => {
  ...
  const services = [
    { icon: <FaCheckCircle className="text-blue-500 text-2xl" />, title: "Deep Cleaning", description: "Removes tough stains and odors from deep within the material" },
    { icon: <FaShieldAlt className="text-blue-500 text-2xl" />, title: "Protection", description: "Specialized coatings to protect against water and dirt" },
    { icon: <FaClock className="text-blue-500 text-2xl" />, title: "Quick Turnaround", description: "Most services completed within 3-5 business days" },
    { icon: <FaRecycle className="text-blue-500 text-2xl" />, title: "Eco-Friendly", description: "Using biodegradable and non-toxic cleaning solutions" },
  ];
    ...
    <section className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 font-sans">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-20 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Professional Shoe Care & Restoration Services</h1>
          <p className="text-xl mb-8 opacity-90 max-w-3xl mx-auto">
            Revitalize your favorite footwear with our expert cleaning, polishing, and repair services. We treat every pair with premium care.
          </p>
      ...
      <div className="bg-gray-100 dark:bg-gray-800 py-8">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          <div className="p-4">
            ...
            <div className="text-gray-600 dark:text-gray-300">Shoes Cleaned</div>
          </div>
          <div className="p-4">
          ...
          <div className="p-4">
            ...
            <div className="text-gray-600 dark:text-gray-300">Brands Serviced</div>
          </div>
          <div className="p-4">
            <div className="text-3xl font-bold text-blue-600">7</div>
            <div className="text-gray-600 dark:text-gray-300">Service Centers</div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="flex justify-center relative">
          ...
          <img
            src={shoesImage}
            alt="Professional Shoe Cleaning Service"
        ...
        <div className="space-y-6">
          <span className="text-blue-600 font-semibold">PREMIUM SHOE CARE</span>
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white leading-tight">
            Expert Care for Your Valued Footwear
          </h2>
          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
            Our certified shoe care specialists use advanced techniques and premium products to restore your shoes to their original glory. Whether it's luxury leather, delicate suede, or performance sneakers, we handle each pair with meticulous attention.
          </p>
      ...
      <div className="bg-gray-50 dark:bg-gray-800 py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold mt-2 mb-4">Transparent Shoe Care Pricing</h2>
            <p className="max-w-2xl mx-auto text-gray-600 dark:text-gray-300">
              Competitive rates for premium services. All prices include pickup and delivery within Delhi.
            </p>
          </div>
            ...
            <table className="min-w-full bg-white dark:bg-gray-700 rounded-xl overflow-hidden shadow-lg">
              <thead>
                <tr className="bg-blue-600 text-white">
                  <th className="p-4 text-left">Shoe Type</th>
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              * Prices may vary for extensive repairs or premium materials
            </p>
            <button 
              onClick={openCallbackForm}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-700 dark:text-gray-300 italic mb-4">
                "My leather boots looked brand new after DhobiLite's service. The water protection treatment has been a game changer in monsoon season!"
              </p>
              <div className="font-semibold">- Rahul Sharma, South Delhi</div>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-700 dark:text-gray-300 italic mb-4">
                "I was skeptical about cleaning my white sneakers, but they removed all the stains without damaging the material. Highly recommended!"
              </p>
              <div className="font-semibold">- Priya Patel, Gurgaon</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-blue-700 to-blue-900 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6">Ready to Restore Your Shoes?</h2>
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            Schedule a pickup today and experience the DhobiLite difference in shoe care.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button 
              onClick={openCallbackForm}
